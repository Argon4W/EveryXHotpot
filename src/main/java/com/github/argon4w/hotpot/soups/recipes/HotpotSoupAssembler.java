...
public class HotpotSoupAssembler {
    ...
    public HotpotSoupAssembleContext withItem(Predicate<ItemStack> predicate) {
        return with(content -> content instanceof HotpotCampfireRecipeContent && predicate.test(((HotpotCampfireRecipeContent) content).getItemStack()));
    }
    ...
    public static class HotpotSoupAssembleContext {
        private final HotpotSoupAssembler assembler;
        private final Predicate<IHotpotContent> predicate;

        public HotpotSoupAssembleContext(HotpotSoupAssembler assembler, Predicate<IHotpotContent> predicate) {

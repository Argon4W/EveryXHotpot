...
public class HotpotSoupBaseRecipe extends AbstractHotpotCommonInputRecipe {
    ...
    public static class Serializer implements RecipeSerializer<HotpotSoupBaseRecipe> {
        ...
        public static final MapCodec<HotpotSoupBaseRecipe> CODEC = LazyMapCodec.of(() -> RecordCodecBuilder.mapCodec(recipe -> recipe.group(
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, HotpotSoupBaseRecipe> STREAM_CODEC = NeoForgeStreamCodecs.lazy(() -> StreamCodec.composite(

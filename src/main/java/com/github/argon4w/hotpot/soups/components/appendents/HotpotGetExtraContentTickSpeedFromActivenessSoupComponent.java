...
import com.github.argon4w.fancytoys.codecs.UniCodec;
import com.github.argon4w.fancytoys.codecs.UniMapCodec;
import com.github.argon4w.fancytoys.codecs.UniRecordCodec;
...
public class HotpotGetExtraContentTickSpeedFromActivenessSoupComponent extends AbstractHotpotSoupComponent {
    ...
    public IHotpotResult<Double> getContentTickSpeed(
        ...
        return result.map(speed -> speed + base + factor * soup
    ...
    public static class Serializer implements IHotpotSoupComponentTypeSerializer<HotpotGetExtraContentTickSpeedFromActivenessSoupComponent> {
        ...
        public static final UniMapCodec<Type> UNI_CODEC = UniRecordCodec.mapCodec(builder -> builder.group(
                UniCodec.DOUBLE.optionalFieldOf("factor", 1.0).forGetter(Type::getFactor),
                UniCodec.DOUBLE.optionalFieldOf("base", 0.0).forGetter(Type::getBase)
        ).apply(builder, Type::new));

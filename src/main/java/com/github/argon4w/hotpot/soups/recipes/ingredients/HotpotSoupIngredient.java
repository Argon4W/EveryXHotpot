...
public record HotpotSoupIngredient(IHotpotSoupIngredientCondition condition, IHotpotSoupIngredientAction action, int amount) {
    ...
    public static final Codec<IHotpotSoupIngredientCondition> CONDITION_CODEC = Codec.lazyInitialized(() -> HotpotSoupIngredients
            .getConditionRegistry()
            .byNameCodec()
            .dispatch(IHotpotSoupIngredientCondition::getSerializer, IHotpotSoupIngredientConditionSerializer::getCodec));

    public static final Codec<IHotpotSoupIngredientAction> ACTION_CODEC = Codec.lazyInitialized(() -> HotpotSoupIngredients
            .getActionRegistry()
            .byNameCodec()
            .dispatch(IHotpotSoupIngredientAction::getSerializer, IHotpotSoupIngredientActionSerializer::getCodec));

    public static final MapCodec<HotpotSoupIngredient> CODEC = LazyMapCodec.of(() -> RecordCodecBuilder.mapCodec(ingredient -> ingredient.group(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, HotpotSoupIngredient> STREAM_CODEC = NeoForgeStreamCodecs.lazy(() -> StreamCodec.composite(

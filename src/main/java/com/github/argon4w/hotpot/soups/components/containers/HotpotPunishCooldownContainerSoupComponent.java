    ...
    public static class Type implements IHotpotSoupComponentType<HotpotPunishCooldownContainerSoupComponent> {
        ...
        public Type(int minCooldown, int maxCooldown) {
            ...
            this.codec = Codec.INT
                    ...
                    .xmap(emptyWaterPunishCooldown -> new HotpotPunishCooldownContainerSoupComponent(minCooldown, maxCooldown, emptyWaterPunishCooldown), HotpotPunishCooldownContainerSoupComponent::getEmptyWaterPunishCooldown);

            this.streamCodec = ByteBufCodecs.INT
                    .<RegistryFriendlyByteBuf>cast()
                    .map(emptyWaterPunishCooldown -> new HotpotPunishCooldownContainerSoupComponent(minCooldown, maxCooldown, emptyWaterPunishCooldown), HotpotPunishCooldownContainerSoupComponent::getEmptyWaterPunishCooldown);
        }

...
public record SimpleModelBaker(Map<ResourceLocation, UnbakedModel> models, UnbakedModel missingModel, Function<Material, TextureAtlasSprite> spriteGetter) implements ModelBaker {
    @NotNull
    @Override
    ...
    public BakedModel bake(ResourceLocation location, UnbakedModel model, ModelState state, Function<Material, TextureAtlasSprite> spriteGetter) {
        if (model instanceof BlockModel blockModel) {
            ...
            return model.bake(this, spriteGetter, state, location);
        }
    }

...
public record HotpotSoupRendererConfigSpriteConfig(
        ResourceLocation id,
        ResourceLocation soupRendererConfigResourceLocation) implements IHotpotSpriteConfig {
    ...
    public static class Serializer implements IHotpotSpriteConfigSerializer<HotpotSoupRendererConfigSpriteConfig> {
        ...
        public static final MapCodec<HotpotSoupRendererConfigSpriteConfig> CODEC = LazyMapCodec.of(() -> RecordCodecBuilder.mapCodec(config -> config.group(
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, HotpotSoupRendererConfigSpriteConfig> STREAM_CODEC = NeoForgeStreamCodecs.lazy(() -> StreamCodec.composite(

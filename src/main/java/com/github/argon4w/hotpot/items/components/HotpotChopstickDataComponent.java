...
public record HotpotChopstickDataComponent(ItemStack itemStack) {
    ...
    public static final Codec<HotpotChopstickDataComponent> CODEC =
            Codec.lazyInitialized(() -> RecordCodecBuilder.create(data -> data.group(ItemStack.OPTIONAL_CODEC
                            .fieldOf("item_stack")
                            .forGetter(HotpotChopstickDataComponent::itemStack))
                    .apply(data, HotpotChopstickDataComponent::new)));

    public static final StreamCodec<RegistryFriendlyByteBuf, HotpotChopstickDataComponent> STREAM_CODEC =
            NeoForgeStreamCodecs.lazy(() -> StreamCodec.composite(
                    ItemStack.STREAM_CODEC,
                    HotpotChopstickDataComponent::itemStack,

...
public record HotpotCustomColorSpriteConfig(
        ResourceLocation id,
        HotpotColor color,
        ResourceLocation processorResourceLocation) implements IHotpotSpriteConfig {
    ...
    public static class Serializer implements IHotpotSpriteConfigSerializer<HotpotCustomColorSpriteConfig> {
        ...
        public static final MapCodec<HotpotCustomColorSpriteConfig> CODEC = LazyMapCodec.of(() -> RecordCodecBuilder.mapCodec(config -> config.group(
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, HotpotCustomColorSpriteConfig> STREAM_CODEC = NeoForgeStreamCodecs.lazy(() -> StreamCodec.composite(

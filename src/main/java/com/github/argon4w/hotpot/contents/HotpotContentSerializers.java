...
public class HotpotContentSerializers {
    ...
    public static final Codec<Sorted<IHotpotContent>> HOLDER_CODEC = Codec.lazyInitialized(() -> Sorted.codec(CODEC, "slot"));
    public static final Codec<NonNullList<IHotpotContent>> HOTPOT_CONTENTS_CODEC = Codec.lazyInitialized(() -> Sorted.codec(HOLDER_CODEC, 8, empty()));
    ...
    public static HotpotEmptyContent empty() {

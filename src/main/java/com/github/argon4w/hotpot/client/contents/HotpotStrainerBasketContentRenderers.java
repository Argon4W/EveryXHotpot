...
import com.github.argon4w.hotpot.client.contents.renderers.strainers.HotpotDefaultStrainerBasketContentRenderer;
import com.github.argon4w.hotpot.client.contents.renderers.strainers.HotpotSkewerStrainerBasketContentRenderer;
...
public class HotpotStrainerBasketContentRenderers {
    ...
    public static final DeferredHolder<IHotpotStrainerBasketContentRenderer, HotpotSkewerStrainerBasketContentRenderer> SKEWER_STRAINER_BASKET_CONTENT_RENDERER = STRAINER_BASKET_CONTENT_RENDERERS.register("hotpot_skewer", HotpotSkewerStrainerBasketContentRenderer::new);
    public static final DeferredHolder<IHotpotStrainerBasketContentRenderer, HotpotDefaultStrainerBasketContentRenderer> DEFAULT_STRAINER_BASKET_CONTENT_RENDERER = STRAINER_BASKET_CONTENT_RENDERERS.register("default_strainer_basket_content_renderer", HotpotDefaultStrainerBasketContentRenderer::new);

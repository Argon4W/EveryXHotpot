...
public class HotpotClientModEvents {
    ...
    public static void onRegisterAdditional(ModelEvent.RegisterAdditional event) {
        ...
        HotpotSoupRendererConfigManager
                .getAllSoupRendererConfigs()
                .stream()
    ...
    public static void onRegisterRenderers(EntityRenderersEvent.RegisterRenderers event) {
        event.registerBlockEntityRenderer(HotpotModEntry.HOTPOT_TEST_BENCH_BLOCK_ENTITY.get(), context -> new HotpotTestBenchBlockEntityRenderer());
        event.registerBlockEntityRenderer(HotpotModEntry.HOTPOT_BLOCK_ENTITY.get(), context -> new HotpotBlockEntityRenderer());
        event.registerBlockEntityRenderer(HotpotModEntry.HOTPOT_PLACEMENT_BLOCK_ENTITY.get(), context -> new HotpotPlacementBlockEntityRenderer());
        event.registerBlockEntityRenderer(HotpotModEntry.HOTPOT_PLACEMENT_RACK_BLOCK_ENTITY.get(), context -> new HotpotPlacementRackBlockEntityRenderer());
        event.registerBlockEntityRenderer(HotpotModEntry.HOTPOT_ELEGANT_PLACEMENT_RACK_BLOCK_ENTITY.get(), context -> new HotpotElegantPlacementRackBlockEntityRenderer());
    }
}

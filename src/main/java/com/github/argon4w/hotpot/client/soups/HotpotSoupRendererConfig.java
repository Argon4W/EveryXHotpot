...
public record HotpotSoupRendererConfig(Optional<ResourceLocation> soupModelResourceLocation, boolean fixedLighting, List<IHotpotSoupCustomElementRenderer> customElementRenderers, Optional<HotpotSoupColor> color) {
    public static final Codec<HotpotSoupRendererConfig> CODEC = Codec.lazyInitialized(() ->
            RecordCodecBuilder.create(config -> config.group(
                    ...
                    HotpotSoupColor.CODEC.optionalFieldOf("color").forGetter(HotpotSoupRendererConfig::color)
